<?xml version="1.0"?>
<!-- AGI_NCDPROOF_01 : Paragon composition transform. Display-name rule #3 lives here (uppercase + title-case mix). Change requires 6-week vendor cycle. -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:output method="xml" indent="no"/>
  <xsl:template match="/Document">
    <PrintJob template="AGI_NCDPROOF_01">
      ...
      <BrandLogo><xsl:choose>
        ...
        <xsl:otherwise>LOGO_AGI_FALLBACK.tif</xsl:otherwise> <!-- heritage letters go out with wrong logo; accepted risk AGI-12361 -->
