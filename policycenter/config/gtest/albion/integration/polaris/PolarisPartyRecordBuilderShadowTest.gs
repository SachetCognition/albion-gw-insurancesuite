...
class PolarisPartyRecordBuilderShadowTest extends TestBase {
  ...
  function testFlagKeysFollowTheDocumentedConvention() {
    assertEquals("po.feature.shadow.polarispartyrecordbuilder.enabled", AlbionFeatureFlags.enabledKey(CENTRE, FEATURE))
    assertEquals("po.feature.shadow.polarispartyrecordbuilder.brands", AlbionFeatureFlags.brandsKey(CENTRE, FEATURE))
    assertEquals("po.feature.shadow.polarispartyrecordbuilder.brand.ALBDIR.enabled",
        AlbionFeatureFlags.brandOverrideKey(CENTRE, FEATURE, "ALBDIR"))
    assertEquals("po.feature.cutover.polarispartyrecordbuilder.enabled", AlbionFeatureFlags.enabledKey(CENTRE, CUTOVER))
  }
