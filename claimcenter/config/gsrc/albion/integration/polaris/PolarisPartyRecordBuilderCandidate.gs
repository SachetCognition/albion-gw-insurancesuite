...
class PolarisPartyRecordBuilderCandidate {
  ...
  public static function buildRecord(src : KeyableBean) : String {
    return new FixedWidthRecordWriter(RECORD_LENGTH, FILLER_CHAR)
        .literal("PO58", 4)
        .text(src.getFieldValue("AnnualPremium_Ext") as String, 15)
        .text(src.getFieldValue("InsuredSurname_Ext") as String, 30)
        .number(src.getFieldValue("PolicyNumber_Ext"), 13)
