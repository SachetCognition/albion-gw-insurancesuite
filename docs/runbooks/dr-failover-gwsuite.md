# Runbook: Dr Failover Gwsuite

**Last exercised:** 03-Nov-2022 — partially — see actions, all open
...
3. Run the recon query in `tools/sql-fixes/` (pick the most recent dr one — they differ, use judgement).
...
5. Re-spool via `albion.integration.common.FlatFileSpooler` restart class — **dev2 first**, it shares an MQ channel with SIT (GWCC-34806).
