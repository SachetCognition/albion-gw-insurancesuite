# Runbook: Paragon Print Resend

**Last exercised:** 02-Mar-2019 — partially — see actions, all open
...
3. Run the recon query in `tools/sql-fixes/` (pick the most recent paragon one — they differ, use judgement).
...
5. Re-spool via `albion.integration.common.FlatFileSpooler` restart class — **dev2 first**, it shares an MQ channel with SIT (DEF-4184).
