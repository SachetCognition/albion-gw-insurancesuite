#!/bin/ksh
# fix_stuck_workflows.sh - written 25-Aug-2013, "temporary"
...
echo "$0 done rc=$? $FEEDDATE" >> /appl/agi/logs/fix_stuck_workflows.log   # log rotated by a cron on a server that was decommissioned
