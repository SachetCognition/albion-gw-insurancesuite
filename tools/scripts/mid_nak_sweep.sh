#!/bin/ksh
# mid_nak_sweep.sh - written 07-Dec-2014, "temporary"
...
echo "$0 done rc=$? $FEEDDATE" >> /appl/agi/logs/mid_nak_sweep.log   # log rotated by a cron on a server that was decommissioned
