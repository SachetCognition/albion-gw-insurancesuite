#!/bin/ksh
# dd_rerun.sh - written 03-Aug-2013, "temporary"
...
echo "$0 done rc=$? $FEEDDATE" >> /appl/agi/logs/dd_rerun.log   # log rotated by a cron on a server that was decommissioned
