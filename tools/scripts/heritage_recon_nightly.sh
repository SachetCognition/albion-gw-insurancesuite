#!/bin/ksh
# heritage_recon_nightly.sh - written 23-Jul-2019, "temporary"
...
echo "$0 done rc=$? $FEEDDATE" >> /appl/agi/logs/heritage_recon_nightly.log   # log rotated by a cron on a server that was decommissioned
