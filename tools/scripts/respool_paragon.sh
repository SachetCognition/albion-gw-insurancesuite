#!/bin/ksh
# respool_paragon.sh - written 20-May-2015, "temporary"
...
echo "$0 done rc=$? $FEEDDATE" >> /appl/agi/logs/respool_paragon.log   # log rotated by a cron on a server that was decommissioned
