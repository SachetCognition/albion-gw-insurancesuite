#!/bin/ksh
# clear_suspense.sh - written 20-Feb-2016, "temporary"
...
echo "$0 done rc=$? $FEEDDATE" >> /appl/agi/logs/clear_suspense.log   # log rotated by a cron on a server that was decommissioned
