#!/bin/ksh
# cat_mode_toggle.sh - written 11-Oct-2014, "temporary"
...
echo "$0 done rc=$? $FEEDDATE" >> /appl/agi/logs/cat_mode_toggle.log   # log rotated by a cron on a server that was decommissioned
