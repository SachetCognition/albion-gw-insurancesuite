-- AGIPRTYX4 : POLARIS DB2 z/OS table (extract of prod catalog 20-Nov-2017)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGIPRTYX4 (
...
CREATE UNIQUE INDEX AGIPROD.XAGIPRTY ON AGIPROD.AGIPRTYX4 (POLREF, MODCODE);
