-- AGICLMHS2 : POLARIS DB2 z/OS table (extract of prod catalog 21-Oct-2017)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGICLMHS2 (
...
CREATE UNIQUE INDEX AGIPROD.XAGICLMH ON AGIPROD.AGICLMHS2 (POLREF, MODCODE);
