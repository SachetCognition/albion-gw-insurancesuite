-- AGICLMHS1 : POLARIS DB2 z/OS table (extract of prod catalog 21-Jan-2017)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGICLMHS1 (
...
CREATE UNIQUE INDEX AGIPROD.XAGICLMH ON AGIPROD.AGICLMHS1 (POLREF, MODCODE);
