-- AGIMIDLG6 : POLARIS DB2 z/OS table (extract of prod catalog 19-Feb-2014)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGIMIDLG6 (
...
CREATE UNIQUE INDEX AGIPROD.XAGIMIDL ON AGIPROD.AGIMIDLG6 (POLREF, MODCODE);
