-- AGIRECON4 : POLARIS DB2 z/OS table (extract of prod catalog 10-Apr-2015)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGIRECON4 (
...
CREATE UNIQUE INDEX AGIPROD.XAGIRECO ON AGIPROD.AGIRECON4 (POLREF, MODCODE);
