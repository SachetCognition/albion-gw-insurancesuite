-- AGIPOLMS6 : POLARIS DB2 z/OS table (extract of prod catalog 20-Jun-2015)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGIPOLMS6 (
...
CREATE UNIQUE INDEX AGIPROD.XAGIPOLM ON AGIPROD.AGIPOLMS6 (POLREF, MODCODE);
