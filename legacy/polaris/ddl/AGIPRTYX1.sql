-- AGIPRTYX1 : POLARIS DB2 z/OS table (extract of prod catalog 19-Jan-2015)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGIPRTYX1 (
...
CREATE UNIQUE INDEX AGIPROD.XAGIPRTY ON AGIPROD.AGIPRTYX1 (POLREF, MODCODE);
