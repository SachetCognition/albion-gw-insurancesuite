-- AGICLMHS6 : POLARIS DB2 z/OS table (extract of prod catalog 21-Jun-2014)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGICLMHS6 (
...
CREATE UNIQUE INDEX AGIPROD.XAGICLMH ON AGIPROD.AGICLMHS6 (POLREF, MODCODE);
