-- AGIMIDLG2 : POLARIS DB2 z/OS table (extract of prod catalog 02-Sep-2014)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGIMIDLG2 (
...
CREATE UNIQUE INDEX AGIPROD.XAGIMIDL ON AGIPROD.AGIMIDLG2 (POLREF, MODCODE);
