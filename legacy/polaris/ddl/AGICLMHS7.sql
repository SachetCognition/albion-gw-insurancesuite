-- AGICLMHS7 : POLARIS DB2 z/OS table (extract of prod catalog 11-Apr-2015)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGICLMHS7 (
...
CREATE UNIQUE INDEX AGIPROD.XAGICLMH ON AGIPROD.AGICLMHS7 (POLREF, MODCODE);
