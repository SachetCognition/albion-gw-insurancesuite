-- AGIPOLMS2 : POLARIS DB2 z/OS table (extract of prod catalog 05-Jan-2016)
-- Referenced by GW migration recon queries. Column meanings per ops folklore.
CREATE TABLE AGIPROD.AGIPOLMS2 (
...
CREATE UNIQUE INDEX AGIPROD.XAGIPOLM ON AGIPROD.AGIPOLMS2 (POLREF, MODCODE);
