...
/*
 * PolarisMfRecordBuilderGoldenMasterTest - Phase 1 golden-master / characterization coverage for PolarisMfRecordBuilder.
 *
 ...
 */
class PolarisMfRecordBuilderGoldenMasterTest extends TestBase {
  ...
  function testCommittedGoldenMasterFixtures() {
    // goldenmaster/good_01.golden - input from integration/samples/polaris_mf/good_01.xml (UAT 20-Dec-2024)
    assertRecord("GWPC-13292", "P365613684X", null, null, "ALBDIR",
        "PO99GWPC-13292  P365613684X                   0000000000000000000000001AD00")

    // goldenmaster/good_05.golden - input from integration/samples/polaris_mf/good_05.xml (UAT 22-Apr-2018)
    assertRecord("INC-32140", "HH59177990A", null, null, "RETPLS",
        "PO99INC-32140   HH59177990A                   0000000000000000000000007RP01")

    // goldenmaster/good_08.golden - input from integration/samples/polaris_mf/good_08.xml (SIT 17-Jun-2019)
    assertRecord("GWPC-449", "HH92613126A", null, null, "HERIT",
        "PO99GWPC-449    HH92613126A                   0000000000000000000000000XX99")

    // goldenmaster/edge_04.golden - input from integration/samples/polaris_mf/edge_04.xml (UAT 25-Jun-2020)
    assertRecord("REG-48263", "AD68912542X", null, null, "HERIT",
        "PO99REG-48263   AD68912542X                   0000000000000000000000000XX99")

    // goldenmaster/edge_06.golden - input from integration/samples/polaris_mf/edge_06.xml (UAT 25-Jun-2018)
    assertRecord("CM-25873", "P315254666A", null, null, "ALBDIR",
        "PO99CM-25873    P315254666A                   0000000000000000000000001AD00")

    // goldenmaster/nak_03.golden - input from integration/samples/polaris_mf/nak_03.xml (PROD (scrubbed) 14-Jul-2022)
    assertRecord("REG-13322", "P324048208C", null, null, "HERIT",
        "PO99REG-13322   P324048208C                   0000000000000000000000000XX99")

    // goldenmaster/nak_09.golden - input from integration/samples/polaris_mf/nak_09.xml (SIT 18-Jan-2025)
    assertRecord("GWPC-19902", "P372414339A", null, null, "RETPLS",
        "PO99GWPC-19902  P372414339A                   0000000000000000000000007RP01")

    // goldenmaster/nak_10.golden - input from integration/samples/polaris_mf/nak_10.xml (SIT 22-Mar-2020)
    assertRecord("GWCC-11880", "P359983410A", null, null, "HERIT",
        "PO99GWCC-11880  P359983410A                   0000000000000000000000000XX99")

    // goldenmaster/prod_incident_02.golden - input from integration/samples/polaris_mf/prod_incident_02.xml (SIT 28-May-2019)
    assertRecord("HERIT-605", "HH56015617A", null, null, "HERIT",
        "PO99HERIT-605   HH56015617A                   0000000000000000000000000XX99")

    // goldenmaster/prod_incident_07.golden - input from integration/samples/polaris_mf/prod_incident_07.xml (UAT 01-Nov-2020)
    assertRecord("GWCC-397", "P359743173B", null, null, "ALBDIR",
        "PO99GWCC-397    P359743173B                   0000000000000000000000001AD00")
  }
   ...
   * before (AGI-30921 / AGI-5452). Phase 1 pins both copies as-is and does not converge them.
   */
  function testBrandCodeMatrixIncludingUnknownAndNull() {
    ...
    assertRecord(null, null, null, null, "NOVABANK",
        "PO99                                          00000000000000000000000999999")
  ...
  function testPipeAndLineEndNormalisation() {
    ...
    assertRecord("PIPE|CR\rLF\nEND", "A|B", null, null, "HERIT",
        "PO99PIPE CR LF EA B                           0000000000000000000000000XX99")

    // tab survives - not in the safe() character class
    assertRecord("TAB\tHERE", null, null, null, "HERIT",
        "PO99TAB\tHERE                                  0000000000000000000000000XX99")
  }
  ...
  function testNegativeAmountEndingInNineStillFails() {
    ...
    try {
      PolarisMfRecordBuilder.buildRecord(source)
  ...
  /**
   * DATE_FORMAT DRIFT - FINDING, NOT FIXED HERE. PolarisMfRecordBuilder declares
   *   DATE_FMT = "yyyyMMdd"   // except InceptionDate_Ext which is ddMMyy because 1987
   * but InceptionDate_Ext is the ONLY date field in this record and it is formatted with DATE_FMT,
  ...
  function testDateFieldUsesYyyyMMddDespiteTheDdMMyyComment() {
    var record = assertRecord(null, null, null, leapDay(), "ALBDIR",
        "PO99                                          0000000000000002020022901AD00")
  ...
  function testNullDateIsEightZeroes() {
    ...
    assertRecord("X", null, null, null, "ALBDIR",
        "PO99X                                         0000000000000000000000001AD00")
  }
  ...
  function testRecordLengthConstantIsPinned() {
    assertEquals(512, PolarisMfRecordBuilder.RECORD_LENGTH)
  }
  ...
  private function mockSource(first : String, second : String, number : BigDecimal, date : Date, brand : String) : KeyableBean {
    ...
    EasyMock.expect(source.getFieldValue("ClaimNumber_Ext")).andReturn(number)
    EasyMock.expect(source.getFieldValue("InceptionDate_Ext")).andReturn(date)
  ...
  private function assertRecord(first : String, second : String, number : BigDecimal, date : Date,
    ...
    var actual = PolarisMfRecordBuilder.buildRecord(source)
