...
/*
 * PrintvRecordBuilderGoldenMasterTest - Phase 2 golden-master / characterization coverage for PrintvRecordBuilder.
 *
 ...
 */
class PrintvRecordBuilderGoldenMasterTest extends TestBase {
  ...
  function testCommittedGoldenMasterFixtures() {
    // goldenmaster/edge_02.golden - PROD (scrubbed... mostly) 04-Nov-2018
    assertRecord("GWBC-31886", "AD82628248C", null, null, "ALBBRK",
        "PR16GWBC-31886  AD82628248C                   0000000000000000000000002BK00")

    // goldenmaster/edge_07.golden - PROD (scrubbed... mostly) 07-May-2022
    assertRecord("INC-23311", "AD89065933A", null, null, "ALBBRK",
        "PR16INC-23311   AD89065933A                   0000000000000000000000002BK00")

    // goldenmaster/good_03.golden - PROD (scrubbed... mostly) 22-Dec-2020
    assertRecord("INC-4811", "P393799400B", null, null, "RETPLS",
        "PR16INC-4811    P393799400B                   0000000000000000000000007RP01")

    // goldenmaster/nak_01.golden - UAT 25-Nov-2023
    assertRecord("PRB-43683", "HH27636108A", null, null, "RETPLS",
        "PR16PRB-43683   HH27636108A                   0000000000000000000000007RP01")

    // goldenmaster/nak_05.golden - UAT 24-Apr-2024
    assertRecord("PRB-20767", "AD94132280B", null, null, "ALBDIR",
        "PR16PRB-20767   AD94132280B                   0000000000000000000000001AD00")

    // goldenmaster/prod_incident_04.golden - PROD (scrubbed... mostly) 09-Apr-2022
    assertRecord("DEF-41187", "AD83000179X", null, null, "ALBDIR",
        "PR16DEF-41187   AD83000179X                   0000000000000000000000001AD00")

    // goldenmaster/prod_incident_06.golden - UAT 14-Aug-2024
    assertRecord("GWCC-17055", "HH53928144A", null, null, "RETPLS",
        "PR16GWCC-17055  HH53928144A                   0000000000000000000000007RP01")
  }
  ...
  function testBrandCodeMatrixIncludingUnknownAndNull() {
    ...
    assertRecord(null, null, null, null, "NOVABANK",
        "PR16                                          00000000000000000000000999999")
  ...
  function testPipeAndLineEndNormalisation() {
    ...
    assertRecord("PIPE|CR\rLF\nEND", "A|B", null, null, "HERIT",
        "PR16PIPE CR LF EA B                           0000000000000000000000000XX99")

    // tab survives - not in the safe() character class
    assertRecord("TAB\tHERE", null, null, null, "HERIT",
        "PR16TAB	HERE                                  0000000000000000000000000XX99")
  }
  ...
  function testNegativeAmountEndingInNineStillFails() {
    ...
    try {
      PrintvRecordBuilder.buildRecord(source)
  ...
  /**
   * DATE_FORMAT DRIFT - FINDING, NOT FIXED HERE. PrintvRecordBuilder declares DATE_FMT = "yyyyMMdd"
   * with a comment claiming ddMMyy, but PolicyNumber_Ext is the ONLY date field in this record
  ...
  function testDateFieldUsesYyyyMMddDespiteTheDdMMyyComment() {
    var record = assertRecord(null, null, null, leapDay(), "ALBDIR",
        "PR16                                          0000000000000002020022901AD00")
  ...
  function testNullDateIsEightZeroes() {
    ...
    assertRecord("X", null, null, null, "ALBDIR",
        "PR16X                                         0000000000000000000000001AD00")
  }
  ...
  function testRecordLengthConstantIsPinned() {
    assertEquals(250, PrintvRecordBuilder.RECORD_LENGTH)
  }
  ...
  private function mockSource(first : String, second : String, number : BigDecimal, date : Date, brand : String) : KeyableBean {
    ...
    EasyMock.expect(source.getFieldValue("PolicyNumber_Ext")).andReturn(date)
  ...
  private function assertRecord(first : String, second : String, number : BigDecimal, date : Date,
    ...
    var actual = PrintvRecordBuilder.buildRecord(source)
