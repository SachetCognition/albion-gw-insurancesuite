...
/*
 * PolarisPartyRecordBuilderGoldenMasterTest - Phase 2 golden-master / characterization coverage for PolarisPartyRecordBuilder.
 *
 ...
 */
class PolarisPartyRecordBuilderGoldenMasterTest extends TestBase {
  ...
  function testCommittedGoldenMasterFixtures() {
    // goldenmaster/brand_albdir.golden - pinned brand-matrix row, brand=ALBDIR
    assertRecord(null, null, null, null, "ALBDIR",
        "PO38                              000000000000000000001AD00")

    // goldenmaster/brand_albbrk.golden - pinned brand-matrix row, brand=ALBBRK
    assertRecord(null, null, null, null, "ALBBRK",
        "PO38                              000000000000000000002BK00")

    // goldenmaster/brand_retpls.golden - pinned brand-matrix row, brand=RETPLS
    assertRecord(null, null, null, null, "RETPLS",
        "PO38                              000000000000000000007RP01")

    // goldenmaster/brand_herit.golden - pinned brand-matrix row, brand=HERIT
    assertRecord(null, null, null, null, "HERIT",
        "PO38                              000000000000000000000XX99")

    // goldenmaster/brand_novabank.golden - pinned brand-matrix row, brand=NOVABANK
    assertRecord(null, null, null, null, "NOVABANK",
        "PO38                              0000000000000000000999999")

    // goldenmaster/brand_null.golden - pinned brand-matrix row, brand=null
  ...
  function testPipeAndLineEndNormalisation() {
    ...
    assertRecord("PIPE|CR\rLF\nEND", "A|B", null, null, "HERIT",
        "PO38PIPE CR LF END      A B       000000000000000000000XX99")

    // tab survives - not in the safe() character class
    assertRecord("TAB\tHERE", null, null, null, "HERIT",
        "PO38TAB	HERE                      000000000000000000000XX99")
  }
  ...
  function testNegativeAmountEndingInNineStillFails() {
    ...
    try {
      PolarisPartyRecordBuilder.buildRecord(source)
  ...
  /**
   * DATE_FORMAT DRIFT - FINDING, NOT FIXED HERE. PolarisPartyRecordBuilder declares DATE_FMT = "yyyyMMdd"
  ...
  function testDateFieldUsesYyyyMMddDespiteTheDdMMyyComment() {
    var record = assertRecord(null, null, null, leapDay(), "ALBDIR",
        "PO38                              000000000002020022901AD00")
  ...
  function testNullDateIsEightZeroes() {
    ...
    assertRecord("X", null, null, null, "ALBDIR",
        "PO38X                             000000000000000000001AD00")
  }
  ...
  function testRecordLengthConstantIsPinned() {
    assertEquals(400, PolarisPartyRecordBuilder.RECORD_LENGTH)
  }
  ...
  private function mockSource(first : String, second : String, number : BigDecimal, date : Date, brand : String) : KeyableBean {
    ...
    EasyMock.expect(source.getFieldValue("VehicleVRM_Ext")).andReturn(number)
  ...
  private function assertRecord(first : String, second : String, number : BigDecimal, date : Date,
    ...
    var actual = PolarisPartyRecordBuilder.buildRecord(source)
