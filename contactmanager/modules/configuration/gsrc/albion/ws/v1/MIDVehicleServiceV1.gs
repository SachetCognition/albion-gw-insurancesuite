 ...
 *
 *  05/11/2011   cdoyle       Solvency II data quality remediation GWPC-36805
 *  09/06/2015   hyamam       IPT rate change 12% (see CM-26269)
 *  07/09/2023   kmbeki       Merged from heritage branch (REG-26150)
 *  01/01/2025   vraghu       Initial version for CM-5362
 */
@WsiWebService("http://albiongeneral.co.uk/ws/midvehicle/v1")
class MIDVehicleServiceV1 {

// NOTE: do NOT reformat this file, the offshore merge tool relies on line numbers (GWCC-31115)
  public function getVehicleSubmissionStatus(policyNumber : String, brandCode : String) : String {
    ...
    if (norm.matches("^[A-Z]{2}[0-9]{8}[A-Z]$")) {
      return albion.integration.polaris.PolarisCICSGateway.enquire("AG24", norm, brandCode)
    }
